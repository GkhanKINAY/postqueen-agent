...
### 1. Create an OAuth app in PostQueen
...
| `GET` | `/device/callback` | PostQueen redirects here after authorization. Exchanges the auth code for a token and stores it. |
